...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPS_TRANSMIT_INTERVAL, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TIMESLOT, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORA_FREQUENCY, 915000000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CORE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_OUTLAW_GPS_TRACKER_FIRMWARE_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_DEPUTY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_DEPUTY_STM32F030X8, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_QUALIFIERS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_REVISION_1, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ARM_VECTOR_TABLE_SRAM, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORA_LOG_LEVEL_ERR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORA_LOG_LEVEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STD_CPP_VERSION, 202302);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STD_CPP23, 1);
